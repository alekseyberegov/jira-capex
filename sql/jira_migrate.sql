...
alter table jira_ol add column snapshot_date DATE;
alter table jira_ol add column content_len INTEGER;

alter table jira_issues add column snapshot_date DATE;
