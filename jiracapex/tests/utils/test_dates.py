...
def test_list_months_the_same_date() -> None:
    ...
    assert len(months) == 1
    assert months[0][0] ==  __d('2022-06-24')
    assert months[0][1] ==  __d('2022-06-24')
...
def test_list_months_next_year() -> None:
    ...
    months: List = list_months(beg_date, end_date)
    assert len(months) == 2
    assert months[0][0] == __d('2022-12-24')
    assert months[0][1] == __d('2022-12-31')
    assert months[1][0] == __d('2023-01-01')
    assert months[1][1] == __d('2023-01-10')
...
def test_list_months_the_same_month() -> None:
    ...
    months: List = list_months(beg_date, end_date)
    assert len(months) == 1
    assert months[0][0] == __d('2022-05-24')
    assert months[0][1] == __d('2022-05-27')
...
def test_list_months_many_months() -> None:
    ...
    months: List = list_months(beg_date, end_date)
    assert len(months) == 4
    assert months[0][0] ==  __d('2022-02-24')
    ...
    assert months[3][1] ==  __d('2022-05-27')
...
def test_list_months_end_of_month_same_date() -> None:
    beg_date: datetime.date = __d('2022-03-31')
    end_date: datetime.date = __d('2022-03-31')
    months: List = list_months(beg_date, end_date)
    assert len(months) == 1
    assert months[0][0] ==  __d('2022-03-31')
    assert months[0][1] ==  __d('2022-03-31')
